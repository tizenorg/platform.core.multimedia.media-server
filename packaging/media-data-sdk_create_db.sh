...
#Create DB
mkdir -p $1/opt/usr/dbspace
sqlite3 $1/opt/usr/dbspace/.media.db 'PRAGMA journal_mode = PERSIST;
...
chmod 775 ${TZ_USER_DATA}/file-manager-service
chmod 775 ${TZ_USER_DATA}/file-manager-service/.thumb
chmod 775 ${TZ_USER_DATA}/file-manager-service/.thumb/phone
chmod 775 ${TZ_USER_DATA}/file-manager-service/.thumb/mmc
chmod 666 ${TZ_USER_CONTENT}/Images/*
