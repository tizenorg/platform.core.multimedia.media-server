...
int ms_cynara_receive_untrusted_message_udp(int sockfd, thumbMsg *recv_msg, unsigned int msg_size, struct sockaddr_un *recv_addr, unsigned int *addr_size, ms_peer_credentials *credentials);
